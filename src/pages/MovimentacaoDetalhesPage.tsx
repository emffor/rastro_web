    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <button
          ...
          className="flex min-h-30 items-center justify-between gap-3 rounded-xl border border-[#e8efe8] bg-apple-gray p-3 text-left text-sm transition-colors hover:bg-[#f4faf4]"
        >
