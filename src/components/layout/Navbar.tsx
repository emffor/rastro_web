  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled
          ? "border-b border-primary-muted bg-white/82 shadow-lg shadow-primary/10 backdrop-blur-xl"
          : "border-b border-primary-muted bg-white/96",
      )}
    >
              ...
              <div className="relative hidden sm:block">
                ...
                {isEmpresaMenuOpen && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 z-20 mt-2 w-56 rounded-xl border border-primary-muted bg-white py-1 shadow-lg shadow-primary/10">
                      <div className="border-b border-primary-muted px-4 py-2">
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            empresa.id === empresaAtual?.id
                              ? "bg-primary-muted text-primary-dark"
                              : "text-apple-dark hover:bg-primary-muted/40",
                          )}
                        >
              ...
              <div className="relative">
                ...
                {isUserMenuOpen && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 z-20 mt-2 w-48 rounded-xl border border-primary-muted bg-white py-1 shadow-lg shadow-primary/10">
                      <div className="border-b border-primary-muted px-4 py-2">
